  ...
  return (
    ...
    >
      ...
      <div className="max-w-lg mx-auto w-full z-10">
        ...
        <div className="fixed bottom-8 left-0 right-0 text-center text-xs text-gray-500 flex items-center justify-center gap-1 pointer-events-none" style={{ zIndex: -1 }}>
          <Shield size={14} />
          隐私受保护，仅用于结果生成
        </div>
      </div>
